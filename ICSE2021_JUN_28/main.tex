...
\renewcommand{\baselinestretch}{0.9516}\selectfont
...
\begin{abstract}
  ...
  the leaked information in a single-trace and deterministic attack through side-channels. 
...
\section*{Supplementary Materials to Submission \#xxx}
