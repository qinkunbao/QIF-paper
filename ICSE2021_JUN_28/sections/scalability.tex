...
domain knowledges~\cite{Wang:2007:NCD:1250662.1250723} to simplify the analysis. 
...
symbolic execution on one execution path one time. Our result indicate the 
...
A native method is to pick elements $k$ from $K$ and check if the
