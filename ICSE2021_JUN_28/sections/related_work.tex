...
DATA~\cite{217537} detects address-based side-channel vulnerabilities by comparing different execution traces \cready{}{of the test program} under various \cready{test}{secret} inputs. 
