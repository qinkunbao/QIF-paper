...
secret-dependent \cready{memory}{data} accesses. \cready{}{In contrast, \tool{} can also detect secret-dependent control-flows accesses and give a precise quantification of the leaked amount for each leakage site.}
