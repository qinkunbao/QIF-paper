...
\cready{}{Pasareanu et al.~\cite{pasareanu2016multi} combines symbolic analysis and Max-SMT solving to synthesize the concrete public input ($m \in M$ in this paper) that can lead to the worst leakage.}
