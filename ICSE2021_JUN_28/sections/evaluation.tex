...
implementation of OpenSSL uses four 1K
 tables with smaller entries instead of the previous 1K table. \jl{Is this right?} The change is rather easy but significantly decreases the total
...
\label{loc:timeout}
We manually check these \jl{timeout?} leakage sites and find most of them are quite severe.
...
we do not present the detailed leakage report, which is available online \jl{where?}. In general,
...
despite it is quite blunt. \jl{What do you mean by blunt?}
\begin{figure}
    \centering
