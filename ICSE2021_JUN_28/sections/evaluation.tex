...
Since DATA~\cite{217537} needs to compare several execution traces to identify
...
(\textsf{int\_bn\_mod\_inverse} leaks more than 14.9 bits and \textsf{BN\_div} leaks more than 17.2 bits), 
which eases the pain to identify real sensitive leaks.
...
contacted the developers and \cready{are waiting for their responses}{they have confirmed our findings}.
