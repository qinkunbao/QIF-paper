...
lookups. The new
implementation of OpenSSL uses one 1K
 tables with smaller entries instead of the previous four 1K table. \jl{Is this right? DW: 4K in the previous sentences?} The change is rather easy but significantly decreases the total
