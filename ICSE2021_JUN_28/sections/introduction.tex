...
reports that the upper-bound leakage of AES-128 exceeds the original key size. Besides, existing quantification work~\cite{182946,5207642} assumes an attacker runs the target program multiple times with different
