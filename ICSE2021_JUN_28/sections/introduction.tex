...
input space reduces to one, an adversary can determine the input, 
...
We have implemented the proposed technique in a tool called \tool{} and shows their merits 
in real-world crypto libraries including OpenSSL, mbedTLS, and Monocypher.
First, we collect execution traces for 
