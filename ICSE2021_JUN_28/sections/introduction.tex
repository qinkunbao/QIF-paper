...
leakages precisely. We quantify the number of leaked bits during one real execution,
and define the amount of leaked information as the cardinality of the set of possible
...
We apply the above technique and build a tool called \tool{} to estimate how
...
several independent bytes, and each byte is treated as a unique and free symbol. Those
...
Finally, we introduce Monte Carlo sampling method to estimate the information leakage. 
...
We evaluate \tool{} on both symmetric and asymmetric ciphers in real-world crypto
...
\begin{itemize}
      ...
      \item We implement the proposed method into a tool and apply it
            ...
            help developers to fix the reported vulnerabilities.
\end{itemize}
