...
information can be leaked through many mechanisms such as power,
...
Although some vulnerabilities can result in the key being 
...
Previous work, such as static methods based on abstract interpretation~\cite{182946,5207642}, provides an upper bound on the amount of leakage, which can verify that an implementation is secure if it incurs zero leakage.
...
Symbolic execution can provide fine-grained information, but it is expensive
...
\begin{itemize}
      ...
      \item We implement the method into a tool and apply it
            ...
            \jl{Different from what?}
            The information leakage estimates provide information that can 
            help developers to triage and fix the vulnerabilities.
\end{itemize}

\cready{}{\tool{} is publicly available at \url{https://github.com/1c0e/Abacus}. The repository also contains benchmarks, metadata, and raw results of our experiments.}