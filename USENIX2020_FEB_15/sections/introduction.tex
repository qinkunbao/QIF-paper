...
and the attacker's observations and run the instruction level symbolic execution on the
whole execution trace to generate constraints. Symbolic execution can
