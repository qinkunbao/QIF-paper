...
attacks. Moreover, we analyze the root cause of many address-based
...
unconsciously through different execution behaviors.  Fundamentally, these
...
\begin{displaymath}
    I = - \log_2p(e)
\end{displaymath}
bits of information by knowing the event $e$ happens. Considering a char variable $a$
...
We consider an attacker that shares the same hardware resource with the victim.
