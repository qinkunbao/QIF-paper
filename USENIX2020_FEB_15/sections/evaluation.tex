...
\begin{table*}[h]
    ...
    \caption{Evaluation results overview. We evaluate two different versions of mbed TLS, five different
        ...
        with the amount of leaked information can be found in the appendix \S\ref{sec:result-table}.
...
comparable performance with LibSodium and NaCl. 
We choose four ciphers that are designed to be more side-channel resistant.
