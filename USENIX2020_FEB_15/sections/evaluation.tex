...
\subsubsection{Symmetric Ciphers}\label{eval:sym}
...
\tool{} also shows that AES\@ in OpenSSL 1.1.1 has less amount of leakages 
compared to other versions by our tools. We find that OpenSSL 1.1.1 version 
...
\subsubsection{Asymmetric Ciphers}\label{eval:asym}
