...
\begin{table*}[h]
    ...
    \begin{tabular}{clrrrrrrr}
        ...
        wget               & 1.18                     & 25                     & 25                  & 0                     &  373,573    & 15.6  & 4.2s          & 5.1s               \\ \hline
...
We evaluate \tool{} on real-world crypto libraries, OpenSSL, mbed TLS and Monocypher\@. OpenSSL
...
embedded devices. We also evaluate Monocypher. It is designed to have no 
secrets dependent indices and no secret dependent branches. Therefore,
Monocypher should have no side-channels under our threat model.
